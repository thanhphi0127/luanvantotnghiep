...
namespace ThapHaNoi_NguyenThanhPhi
{
    public partial class ThapHaNoi : PhoneApplicationPage
    {
        ...
        public ThapHaNoi()
        {
           ...
           // pics = new Picture[] { Disk1, pics2, pic3, pic4, pic5, pic6, pic7, pic8, pic8, pic9, pic10};
        ...
        void TimerTick(object sender, EventArgs e)
        {
            ...
            txtThoigian.Text = string.Format(Const.TimeFormat, time.Hours, time.Minutes, time.Seconds);
        }
